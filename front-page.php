...
<main>
  ...
  <section class="top-service">
			...
			<div class="top-service__contents">
				<div class="service__content service__content--right">
					...
					<div class="service__img">
						<img src="<?php echo get_template_directory_uri() ?>/images/lp-service-pc01.jpg"
							alt="">
					</div>
        ...
        <div class="service__content service__content--left">
					...
					<div class="service__img">
						<img src="<?php echo get_template_directory_uri() ?>/images/lp-service-pc02.jpg"
							alt="">
					</div>
        ...
        <div class="service__content service__content--right">
					...
					<div class="service__img">
						<img src="<?php echo get_template_directory_uri() ?>/images/lp-service-pc03.jpg"
							alt="">
					</div>
					<div class="service__bg service__bg--right u-desktop">
